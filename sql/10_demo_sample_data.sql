...
INSERT INTO GOVERNANCE.CONTRACT_REGISTRY.CONTRACTS 
    (CONTRACT_ID, CONTRACT_TYPE, VERSION, STATUS, PRODUCER_SYSTEM, PRODUCER_EMAIL, DESCRIPTION, YAML_DEFINITION)
VALUES
    ('tpch_customer_v1', 'data', '1.0.0', 'active', 'TPCH_DEMO', 'data-eng@company.com', 
    ...
    ('tpch_orders_v1', 'data', '1.0.0', 'active', 'TPCH_DEMO', 'data-eng@company.com',
    ...
    ('tpch_lineitem_v1', 'data', '1.0.0', 'active', 'TPCH_DEMO', 'data-eng@company.com',
    ...
    ('tpch_part_v1', 'data', '1.0.0', 'active', 'TPCH_DEMO', 'data-eng@company.com',
    ...
    ('tpch_supplier_v1', 'data', '1.0.0', 'active', 'TPCH_DEMO', 'data-eng@company.com',
    ...
    ('tpch_nation_v1', 'data', '1.0.0', 'active', 'TPCH_DEMO', 'data-eng@company.com',
    ...
    ('tpch_region_v1', 'data', '1.0.0', 'active', 'TPCH_DEMO', 'data-eng@company.com',
    ...
    ('tpch_partsupp_v1', 'data', '1.0.0', 'active', 'TPCH_DEMO', 'data-eng@company.com',
...
INSERT INTO GOVERNANCE.CONTRACT_REGISTRY.CONTRACTS 
    (CONTRACT_ID, CONTRACT_TYPE, VERSION, STATUS, PRODUCER_SYSTEM, PRODUCER_EMAIL, DESCRIPTION, YAML_DEFINITION)
VALUES
    ('sem_sales_analytics_v1', 'product', '1.0.0', 'active', 'SEM_DEV', 'analytics@company.com',
    ...
    ('sem_customer_analytics_v1', 'product', '1.0.0', 'active', 'SEM_DEV', 'analytics@company.com',

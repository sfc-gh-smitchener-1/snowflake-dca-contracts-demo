...
-- Note: Governance tags flow from base tables (FACT_ORDERS, FACT_LINEITEM, etc.)
-- Grant access
...
-- Note: Governance tags flow from base tables (DIM_CUSTOMER, FACT_CUSTOMER_ORDERS_SUMMARY, etc.)
-- Grant access
...
-- Note: Governance tags flow from base tables (DIM_SUPPLIER, FACT_LINEITEM, FACT_PARTSUPP)
-- Grant access
...
-- Note: Governance tags flow from base tables (DIM_PART, FACT_LINEITEM, FACT_PARTSUPP)
-- Grant access

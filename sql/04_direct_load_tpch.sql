...
-- ─────────────────────────────────────────────────────────────────────────────
-- MASTER LOAD - Execute All Loads in Sequence
-- ─────────────────────────────────────────────────────────────────────────────
-- Note: Run these calls individually or use the script below

-- To run full load, execute these in order:
-- CALL RAW_DEV.RAW_TPCH.LOAD_REGION();
-- CALL RAW_DEV.RAW_TPCH.LOAD_NATION();
-- CALL RAW_DEV.RAW_TPCH.LOAD_CUSTOMER(TRUE);
-- CALL RAW_DEV.RAW_TPCH.LOAD_SUPPLIER(TRUE);
-- CALL RAW_DEV.RAW_TPCH.LOAD_PART(TRUE);
-- CALL RAW_DEV.RAW_TPCH.LOAD_PARTSUPP(TRUE);
-- CALL RAW_DEV.RAW_TPCH.LOAD_ORDERS(TRUE);
-- CALL RAW_DEV.RAW_TPCH.LOAD_LINEITEM(TRUE);

-- ─────────────────────────────────────────────────────────────────────────────
-- EXECUTE INITIAL LOAD
-- ─────────────────────────────────────────────────────────────────────────────

-- Run initial full load - execute each procedure in order
CALL RAW_DEV.RAW_TPCH.LOAD_REGION();
CALL RAW_DEV.RAW_TPCH.LOAD_NATION();
CALL RAW_DEV.RAW_TPCH.LOAD_CUSTOMER(TRUE);
CALL RAW_DEV.RAW_TPCH.LOAD_SUPPLIER(TRUE);

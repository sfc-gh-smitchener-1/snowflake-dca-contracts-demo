...
-- ─────────────────────────────────────────────────────────────────────────────
-- DROP DEMO ROLES (Created by 10_roles_and_users.sql)
-- ─────────────────────────────────────────────────────────────────────────────

-- Revoke role grants first
REVOKE ROLE DATA_ENGINEER FROM ROLE DATA_ADMIN;
REVOKE ROLE DATA_STEWARD FROM ROLE DATA_ADMIN;
REVOKE ROLE DATA_ANALYST FROM ROLE DATA_ENGINEER;
REVOKE ROLE BI_VIEWER FROM ROLE DATA_ANALYST;
REVOKE ROLE AI_AGENT FROM ROLE DATA_ANALYST;
REVOKE ROLE PII_VIEWER FROM ROLE DATA_STEWARD;
...
SELECT 'Remaining Demo Databases:' AS CHECK_TYPE, 
       COALESCE(LISTAGG(DATABASE_NAME, ', '), 'None') AS DATABASES
